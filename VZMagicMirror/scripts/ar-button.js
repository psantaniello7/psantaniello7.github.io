const INNER_FRAME_URL = 'https://infovisioninc.8thwall.app/magic-mirror'
...
const startAR = () => {
  ...
  iframe.addEventListener('load', function() {
    setTimeout(() => {
      iframe.contentWindow.postMessage(thismessage,'https://infovisioninc.8thwall.app/magic-mirror')
      thismessage = null
    }, 5000)
  })
